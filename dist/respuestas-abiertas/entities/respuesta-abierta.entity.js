...
__decorate([
    (0, typeorm_1.ManyToOne)(() => pregunta_entity_1.Pregunta, pregunta => pregunta.respuestasAbiertas, { onDelete: 'CASCADE' }),
    __metadata("design:type", pregunta_entity_1.Pregunta)
], RespuestaAbierta.prototype, "pregunta", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => respuesta_entity_1.Respuesta, respuesta => respuesta.abiertas, { onDelete: 'CASCADE' }),
